...
public class SnowFlakeIdGenerator {
    ...
    //总的分区数
    private final static int SHARDING_NUM = Constant.ShardingConstants.SHARDING_LENGTH;
    ...
    public static void main(String[] args) throws InterruptedException {
        for(int i=1;i<10;i++){
            Long id = SnowFlakeIdGenerator.getUniqueId(1023, i);
